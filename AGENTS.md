...
C# (.NET) demo app for Deepgram Transcription.
...
```
feat(csharp-transcription): add diarization support
fix(csharp-transcription): resolve WebSocket close handling
refactor(csharp-transcription): simplify session endpoint
